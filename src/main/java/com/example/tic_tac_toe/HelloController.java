...
public class HelloController {
    ...
    void btnClick(ActionEvent event) {
        ...
        if(gameField[2][0] == gameField[2][1] && gameField[2][2] == gameField[2][0] && (gameField[2][0] == 'x' || gameField[2][0] == 'o')) {
            Alert alert =new Alert(Alert.AlertType.INFORMATION, "у нас есть победитель«"+ btn.getText() +"»", ButtonType.OK);
            alert.showAndWait();
            isGame = false;
        }
        ...
        if(gameField[0][1] == gameField[1][1] && gameField[2][1] == gameField[0][1] && (gameField[0][1] == 'x' || gameField[0][1] == 'o')) {
            Alert alert =new Alert(Alert.AlertType.INFORMATION, "у нас есть победитель«"+ btn.getText() +"»", ButtonType.OK);
            alert.showAndWait();
            isGame = false;
        }
        if(gameField[0][2] == gameField[1][2] && gameField[2][2] == gameField[0][2] && (gameField[0][2] == 'x' || gameField[0][2] == 'o')) {
            Alert alert =new Alert(Alert.AlertType.INFORMATION, "у нас есть победитель«"+ btn.getText() +"»", ButtonType.OK);
            alert.showAndWait();
            isGame = false;
        }
